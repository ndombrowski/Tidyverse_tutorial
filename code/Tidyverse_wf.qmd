...
In the code below, we use our first pipe `|>` to filter our dataframe and then pass it into the nrow function to count the number of rows retained in our dataframe.
